...
namespace Bimangle.ForgeEngine.Skp.UI.Controls
{
    ...
    partial class ExportSvfzip : UserControl, IExportControl
    {
        ...
        void IExportControl.Init(IExportForm form, AppConfig config)
        {
            ...
            _VisualStyles.Add(new VisualStyleInfo(@"Textured", Strings.VisualStyleTextured));
        ...
        private void InitUI()
        {
            ...
            #region 高级
            {
                ...
                if (_Features.IsEnabled(FeatureType.OptimizationFaceMaterial))
                {
        ...
        private Options BuildOptions()
        {
            ...
            _Features.Set(FeatureType.OptimizationFaceMaterial, cbOptimizationFaceMaterial.Checked);
