...
{
    public class ParameterLocalModel : AbstractModel, IDataErrorInfo
    {
        private readonly GeoreferencedSetting _Setting;
        private readonly IGeoreferncingHost _Host;
        private readonly ParameterLocal _LocalSetting;
        ...
        public ParameterLocalModel(GeoreferencedSetting setting, IGeoreferncingHost host)
        {
            _Setting = setting ?? throw new ArgumentNullException(nameof(setting));
            _Host = host ?? throw new ArgumentNullException(nameof(host));
            _LocalSetting = _Setting.Local;
        ...
        /// </summary>
        public bool UpdateTo(ParameterLocal p, out string firstErrorProperty)
        {
        ...
        /// </summary>
        public void Reset(ParameterLocal defaultParam)
        {
            var p = defaultParam;
            Origin = p.Origin;
