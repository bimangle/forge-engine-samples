...
{
    static class WpfTextHelper
    {
        public static bool TryParseLatitude(this string text, out string error, out double n)
        {
            return text.TryParseLatLon(out error, -90.0, 90.0, GeoStrings.ErrorMessageLatitude, out n);
        }

        public static bool TryParseLongitude(this string text, out string error, out double n)
        {
            return text.TryParseLatLon(out error, -180.0, 180.0, GeoStrings.ErrorMessageLongitude, out n);
        }

        public static bool TryParseHeight(this string text, out string error, out double n)
        {
            return text.TryParse(out error, double.MinValue, double.MaxValue, GeoStrings.ErrorMessageHeight, out n);
        }

        public static bool TryParseRotation(this string text, out string error, out double n)
        {
            return text.TryParse(out error, -360.0, 360.0, GeoStrings.ErrorMessageRotation, out n);
        }

        public static bool TryParseNumber(this string text, out string error, out double n)
        {
            return text.TryParse(out error, double.MinValue, double.MaxValue, GeoStrings.ErrorMessageNumber, out n);
        }
        ...
        /// </remarks>
        /// <returns></returns>
        private static bool TryParseLatLon(this string text, out string error, double min, double max, string errorInfo, out double n)
        {
            error = null;
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        private static bool TryParse(this string text, out string error, double min, double max, string errorInfo, out double n)
        {
            error = null;
            n = 0.0;
