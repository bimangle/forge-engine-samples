...
namespace Bimangle.ForgeEngine.Georeferncing {
    ...
    internal class GeoStrings {
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to cancel? Any unsaved changes will be discarded. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The projection coordinate system definition cannot be empty. 的本地化字符串。
        /// </summary>
        internal static string ProjDefinitionIsRequired {
            get {
                return ResourceManager.GetString("ProjDefinitionIsRequired", resourceCulture);
            }
        }
