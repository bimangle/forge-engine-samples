...
namespace Bimangle.ForgeEngine.Dwg.UI.Controls
{
    ...
    partial class ExportGltf : UserControl, IExportControl
    {
        ...
        void IExportControl.Init(IExportForm form, AppConfig config)
        {
            ...
            _VisualStyles.Add(new VisualStyleInfo(@"Auto", Strings.VisualStyleAuto));
            _VisualStyles.Add(new VisualStyleInfo(@"Wireframe", Strings.VisualStyleWireframe + $@"({Strings.TextDefault})", FeatureType.Wireframe));
            ...
            if (!DesignMode)
            {
                FormHelper
                    .ToArray(txtTargetPath,
                        cbVisualStyle, cbGenerateThumbnail,
