...
namespace Bimangle.ForgeEngine.Dwg.UI.Controls
{
    ...
    partial class ExportCesium3DTiles : UserControl, IExportControl
    {
        ...
        private Features<PreFeatureType> _PreFeatures;
        ...
        void IExportControl.Init(IExportForm form, AppConfig config)
        {
            ...
            _PreFeatures = new Features<PreFeatureType>();

            _VisualStyles = new List<VisualStyleInfo>();
            _VisualStyles.Add(new VisualStyleInfo(@"Auto", Strings.VisualStyleAuto, FeatureType.VisualStyleAuto));
            _VisualStyles.Add(new VisualStyleInfo(@"Wireframe", Strings.VisualStyleWireframe + $@"({Strings.TextDefault})", FeatureType.ExcludeTexture, FeatureType.Wireframe));
            _VisualStyleDefault = _VisualStyles.First(x => x.Key == @"Wireframe");
            ...
            if (!DesignMode)
            {
                FormHelper
                    .ToArray(txtTargetPath,
                        cbVisualStyle, cbGenerateThumbnail, cbGenerateOutline,
                        cbIncludeInvisibleLayers, cbIncludeUnplottableLayers, cbOptimizationLineStyle,
        ...
        private void InitUI()
        {
            ...
            _PreFeatures.Init(config.PreFeatures);
            ...
            #region 包括
            {
                ...
                cbIncludeInvisibleLayers.Checked = _PreFeatures.IsEnabled(PreFeatureType.IncludeInvisibleLayers);
                cbIncludeUnplottableLayers.Checked = _PreFeatures.IsEnabled(PreFeatureType.IncludeUnplottableLayers);
            }
            #endregion
            ...
            #region 其它
            {
                ...
                cbOptimizationLineStyle.Checked = _PreFeatures.IsEnabled(PreFeatureType.OptimizationLineStyle);
            }
            #endregion
        ...
        private Options BuildOptions()
        {
            ...
            _PreFeatures.Set(PreFeatureType.IncludeInvisibleLayers, cbIncludeInvisibleLayers.Checked);
            _PreFeatures.Set(PreFeatureType.IncludeUnplottableLayers, cbIncludeUnplottableLayers.Checked);
            _PreFeatures.Set(PreFeatureType.OptimizationLineStyle, cbOptimizationLineStyle.Checked);

            if (_Features.IsEnabled(FeatureType.Wireframe))
            {
                _Features.Set(FeatureType.Wireframe, false);
                _PreFeatures.Set(PreFeatureType.ForceRenderModeUseWireframe, true);
            }
            ...
            features.AddRange(_Features.GetEnabledFeatures().Select(x => x.ToString()));
            features.AddRange(_PreFeatures.GetEnabledFeatures().Select(x => x.ToString()));
            ...
            config.PreFeatures = _PreFeatures.GetEnabledFeatures().ToList();
