...
namespace Bimangle.ForgeEngine.Revit.Toolset.PickPositionFromMap
{
    [Transaction(TransactionMode.Manual)]
    public class CommandToolsetPickPositionFromMap : IExternalCommand, IExternalCommandAvailability
    {
