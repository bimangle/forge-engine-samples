...
namespace Bimangle.ForgeEngine.Revit.Georeferncing
{
    static class ProjBuilder
    {
        ...
        public static ProjDefinition CreateProj(this ProjValidator validator, GeoGCS gcs, double e, double n, double lon, double lat)
        {
            //先创建一个默认的投影定义
            ...
            //算出经纬度坐标对应于投影坐标系的坐标值
            var r = validator.CalcProjCoordinates(proj.ToWKT(), lon, lat);
