...
namespace Bimangle.ForgeEngine.Navisworks.Georeferncing
{
    partial class FormProjParamCalc : Form
    {
        ...
        {
            txtRefPointLocalY.Text = _LastState?.RefPointLocalY ?? string.Empty;
            txtRefPointLocalX.Text = _LastState?.RefPointLocalX ?? string.Empty;
            ...
            {
                lblRefPointLocalX.SetDirectionLetter(doc.RightVector, @"X");
                lblRefPointLocalY.SetDirectionLetter(doc.FrontVector, @"Y");
            }
        }
